...
//L293 Connection   
  const int motorURF  = 5;  // Pin  2 of L293    omar upper right
  const int motorURB = 6;  // Pin  7 of L293    omar upper left
  const int motorULF  = 10; // Pin 10 of L293    omar lower right
  const int motorULB = 9;  // Pin 14 of L293   omar lower left 
  const int motorLRF  = 50;  // Pin  2 of L293    omar upper right zawdt 0 bs 3n ely fo2
  const int motorLRB = 60;  // Pin  7 of L293    omar upper left
  const int motorLLF  = 100; // Pin 10 of L293    omar lower right
  const int motorLLB = 90;  // Pin 14 of L293   omar lower left 
